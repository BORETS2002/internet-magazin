        ...
        <div className='grid-cols-1 sm:grid md:grid-cols-3 '>
          ...
          <div className='mx-3 mt-6 flex flex-col self-start rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 sm:shrink-0 sm:grow sm:basis-0'>
            ...
            <div className='p-6'>
              ...
              <p className='mb-4 text-base text-neutral-600 dark:text-neutral-200'>
                ...
                «Chriwa» Германия, линии розлива «Krones» Германия, линии
                розлива «Comac» Италия, линии розлива «KHS» Германия и линии
                розлива «SIPA» Италия.
              </p>
            </div>
          </div>
          <div className='mx-3 mt-6 flex flex-col self-start rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 sm:shrink-0 sm:grow sm:basis-0'>
            ...
            <div className='p-6'>
              ...
              <p className='mb-4 text-base text-neutral-600 dark:text-neutral-200'>
                Успех использования ПЭТ преформ в качестве упаковки — прежде
                всего в ее экономичности, т.е. малом расходе материала,
                необходимого для упаковки товара. Рассматривая упаковочную
                отрасль в целом, можно отметить, что наиболее емкими являются
                сегменты гофрокартонной тары, упаковки из бумаги и картона,
                упаковки из полимерных пленок.
              </p>
            </div>
          </div>
        </div>
